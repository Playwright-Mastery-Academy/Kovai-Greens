...
function ProductCard({ product, add, favorite, toggleFavorite }: { product: Product; add: (p: Product, grams: number) => void; favorite: boolean; toggleFavorite: () => void }) {
